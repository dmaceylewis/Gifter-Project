    ...
    public class PostRepository : BaseRepository, IPostRepository
    {
        ...
        public Post GetById(int id)
        {
            using (var conn = Connection)
            {
                ...
                {
                    cmd.CommandText = @"
                          SELECT p.Id AS PostId, p.Title, p.Caption, p.DateCreated, p.ImageUrl, p.UserProfileId,
                            up.Id AS UserProfileId, up.Name, up.Email, up.ImageUrl AS UserProfileImageUrl, up.DateCreated AS UserProfileDateCreated
                            FROM Post p
        ...
        public List<Post> GetHottestPosts(DateTime since, bool sortDescending)
        {
            using (var conn = Connection)
            {
                conn.Open();
                ...
                ORDER BY p.DateCreated DESC";
                    ...
                    while (reader.Read())
                    {
                        posts.Add(new Post
                        {
                            ...
                            DateCreated = DbUtils.GetDateTime(reader, "PostDateCreated"),
                            ImageUrl = DbUtils.GetString(reader, "PostImageUrl"),
                            UserProfileId = userId // UserProfileId is the same as the userId parameter
                        });
                    }
